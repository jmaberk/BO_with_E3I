...
% estimated
%a=[ 0.04723732,  0.38308447,  0.0777039 ,  0.        ,  0.52071331,        1.        ,  0.0052209 ,  0.        ];

a=[2.26588617, -0.54511502,  0.13562001, -6.41164983, -4.05295103,  0.01608049,  4.90118378, -0.27008371];

%a=[7.72775358e-01,  -5.49423726e-01,  -2.41268904e-01, -4.75073043e+00,  -3.46704024e+00,   2.97616753e+00,  3.32795051e+00,   9.08317203e-01];

%a = [0 0 1 0 1 1 0 0.3176];
...
%fprintf('max vH =%.2f ',max(vH));
%fprintf('end vH =%.2f ',vH(end));
%hz_velocity=max(vH);
hz_velocity=vH(end);
...
for k=2:n
    ...
    title(['Horizontal Velocity = ',num2str(max(hz_velocity),'%.3f')])
